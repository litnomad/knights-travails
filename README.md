...
The objective is to use breadth first search to find the shortest path between two squares or vertices that the knight can move across the edges of the chessboard. (the Odin Project curriculum: https://www.theodinproject.com/lessons/javascript-knights-travails)
